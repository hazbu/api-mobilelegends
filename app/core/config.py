...
RONE_DEV_ACCESS_KEY: str = env_str("RONE_DEV_ACCESS_KEY", default="https://api.mobilelegends.com/gms/api/client/content")
RONE_DEV_ACCESS_KEY_V2: str = env_str("RONE_DEV_ACCESS_KEY_V2", default="https://api.mobilelegends.com/gms/api/client/content")
